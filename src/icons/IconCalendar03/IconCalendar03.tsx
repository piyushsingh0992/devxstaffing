...
export const IconCalendar03 = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      ...
      <path
        ...
        strokeWidth="1.25"
      />
      <path d="M2.5 6.66666H17.5" stroke="#8C8EA5" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
    </svg>
  );
};
