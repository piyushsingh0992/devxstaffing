...
export const IconFile011 = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      ...
      <path
        ...
        strokeWidth="1.5"
      />
      <path d="M8 7H15" stroke="#8C8EA5" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
      <path d="M8 11H11" stroke="#8C8EA5" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
    </svg>
  );
};
