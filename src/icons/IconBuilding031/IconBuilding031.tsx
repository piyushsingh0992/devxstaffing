...
export const IconBuilding031 = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <path
        ...
        strokeWidth="1.5"
      />
      <path d="M8 9L11 9M8 13L11 13" stroke="#8C8EA5" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
      <path
        ...
        strokeWidth="1.5"
      />
      <path d="M2 22L22 22" stroke="#8C8EA5" strokeLinecap="round" strokeWidth="1.5" />
      <path
