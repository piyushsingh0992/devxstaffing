...
export const IconLayout3Column1 = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <path
        ...
        strokeWidth="1.5"
      />
      <path d="M8.5 2.5V21.5" stroke="#8C8EA5" strokeWidth="1.5" />
      <path d="M15.5 2.5V21.5" stroke="#8C8EA5" strokeWidth="1.5" />
    </svg>
  );
};
