...
export const IconShare082 = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`icon-share-08-2 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      ...
      <path
        className="path"
        d="M8.72852 10.7498L15.2285 7.75031M8.72852 13.2503L15.2285 16.2498"
        stroke="#8C8EA5"
        strokeWidth="1.5"
      />
    </svg>
