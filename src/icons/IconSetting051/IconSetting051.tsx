...
export const IconSetting051 = ({ color = "#8C8EA5", className }: Props): JSX.Element => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      ...
      <path
        ...
        stroke={color}
      />
      <path d="M6.66667 5.66669L11.3333 5.66669" stroke={color} strokeLinecap="round" />
      <path d="M9.33333 10.3333L4.66667 10.3333" stroke={color} strokeLinecap="round" />
    </svg>
  );
};
