...
export const IconLeftToRightListTriangle1 = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <path d="M11 5.5L21 5.5" stroke="#8C8EA5" strokeLinecap="round" strokeWidth="1.5" />
      <path
      ...
      <path
        ...
        strokeWidth="1.5"
      />
      <path d="M11 12L21 12" stroke="#8C8EA5" strokeLinecap="round" strokeWidth="1.5" />
      <path d="M11 18.5L21 18.5" stroke="#8C8EA5" strokeLinecap="round" strokeWidth="1.5" />
    </svg>
  );
};
