...
export const IconShare081 = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      ...
      <path
        ...
        strokeWidth="1.5"
      />
      <path d="M8.72852 10.7498L15.2285 7.75031M8.72852 13.2503L15.2285 16.2498" stroke="#8C8EA5" strokeWidth="1.5" />
    </svg>
  );
};
