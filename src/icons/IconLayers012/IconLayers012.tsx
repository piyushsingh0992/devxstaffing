...
export const IconLayers012 = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`icon-layers-01-2 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      ...
      <path
        className="path"
        d="M20.788 11.0972C20.9293 11.296 21 11.5032 21 11.731C21 12.7128 19.6873 13.311 17.0618 14.5072L15.357 15.284C13.7048 16.0369 12.8786 16.4133 12 16.4133C11.1214 16.4133 10.2952 16.0369 8.64298 15.284L6.93817 14.5072C4.31272 13.311 3 12.7128 3 11.731C3 11.5032 3.07067 11.296 3.212 11.0972"
        stroke="#8C8EA5"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="1.5"
