...
export const IconShare02 = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`icon-share-02 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      ...
      <path
        ...
        strokeWidth="1.5"
      />
      <circle className="circle" cx="5" cy="19" r="3" stroke="#8C8EA5" strokeWidth="1.5" />
      <circle className="circle" cx="19" cy="19" r="3" stroke="#8C8EA5" strokeWidth="1.5" />
    </svg>
  );
};
