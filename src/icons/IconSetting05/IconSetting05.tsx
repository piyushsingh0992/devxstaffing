...
export const IconSetting05 = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      ...
      <path
        ...
        strokeWidth="1.5"
      />
      <path d="M10 8.5L17 8.5" stroke="#8C8EA5" strokeLinecap="round" strokeWidth="1.5" />
      <path d="M14 15.5L7 15.5" stroke="#8C8EA5" strokeLinecap="round" strokeWidth="1.5" />
    </svg>
  );
};
