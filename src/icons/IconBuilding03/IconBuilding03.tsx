...
export const IconBuilding03 = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`icon-building-03 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      ...
      <path
        ...
        strokeWidth="1.5"
      />
      <path className="path" d="M2 22L22 22" stroke="#8C8EA5" strokeLinecap="round" strokeWidth="1.5" />
      <path
        className="path"
